...
class GameSetTest {
	...
	void getLastWurf_after_all_throws_and_reset() {
		var wurf1 = mock(Wurf.class);
		var wurf2 = mock(Wurf.class);
	...
	void isCompleted_true() {
		gameSet.set(0, mock(Wurf.class));
		gameSet.set(1, mock(Wurf.class));
